...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Standalone.mk dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=require --mode=free -P -N255 -I"../Source/h/01_Hal/01_Sys" -I"../Source/h/01_Hal/02_Drv" -I"../Source/h/02_Osl" -I"../Source/h/03_Sml/01_Pml/01_Mdm" -I"../Source/h/03_Sml/01_Pml/02_SlvI2c" -I"../Source/h/03_Sml/01_Pml/03_SlvSer" -I"../Source/h/03_Sml/01_Pml/04_Usb" -I"../Source/h/03_Sml/02_Ssl" -I"../Source/h/00_Cfg" --warn=0 --cci --asmlist -DXPRJ_Standalone=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.map  --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=require --mode=free -P -N255 -I"../Source/h/01_Hal/01_Sys" -I"../Source/h/01_Hal/02_Drv" -I"../Source/h/02_Osl" -I"../Source/h/03_Sml/01_Pml/01_Mdm" -I"../Source/h/03_Sml/01_Pml/02_SlvI2c" -I"../Source/h/03_Sml/01_Pml/03_SlvSer" -I"../Source/h/03_Sml/01_Pml/04_Usb" -I"../Source/h/03_Sml/02_Ssl" -I"../Source/h/00_Cfg" --warn=0 --cci --asmlist -DXPRJ_Standalone=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
