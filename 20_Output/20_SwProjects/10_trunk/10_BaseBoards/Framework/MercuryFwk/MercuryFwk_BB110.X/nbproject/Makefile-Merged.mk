...
ifeq "$(wildcard nbproject/Makefile-local-Merged.mk)" "nbproject/Makefile-local-Merged.mk"
include nbproject/Makefile-local-Merged.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Merged.mk dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=pickit3  -DXPRJ_Merged=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --rom=default,-0-1FFF,-2006-2007,-2016-2017,-EFFF-FFFF --opt=+asm,-asmfile,-speed,+space,-debug,-local --addrqual=require --mode=free -P -N255 -I"../Source/h/01_Hal/01_Sys" -I"../Source/h/01_Hal/02_Drv" -I"../Source/h/02_Osl" -I"../Source/h/03_Sml/01_Pml/01_Mdm" -I"../Source/h/03_Sml/01_Pml/02_SlvI2c" -I"../Source/h/03_Sml/01_Pml/03_SlvSer" -I"../Source/h/03_Sml/01_Pml/04_Usb" -I"../Source/h/03_Sml/02_Ssl" -I"../Source/h/00_Cfg" --warn=0 --cci --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    F\:/_Repository/Progetti/Prodotti/2016/FFPR1601_MercurySystem/20_Output/20_SwProjects/SW_BaseBoards/trunk/Bootloader/BootFwk/MercuryBoot_BB110.X/dist/default/production/MercuryBoot_BB110.X.production.hex
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.map  -DXPRJ_Merged=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --rom=default,-0-1FFF,-2006-2007,-2016-2017,-EFFF-FFFF --opt=+asm,-asmfile,-speed,+space,-debug,-local --addrqual=require --mode=free -P -N255 -I"../Source/h/01_Hal/01_Sys" -I"../Source/h/01_Hal/02_Drv" -I"../Source/h/02_Osl" -I"../Source/h/03_Sml/01_Pml/01_Mdm" -I"../Source/h/03_Sml/01_Pml/02_SlvI2c" -I"../Source/h/03_Sml/01_Pml/03_SlvSer" -I"../Source/h/03_Sml/01_Pml/04_Usb" -I"../Source/h/03_Sml/02_Ssl" -I"../Source/h/00_Cfg" --warn=0 --cci --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
	@echo "Creating unified hex file"
	@"C:/Program Files (x86)/Microchip/MPLABX/v5.30/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/v5.30/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" -break=FFF8  dist/${CND_CONF}/${IMAGE_TYPE}/MercuryFwk_BB110.X.${IMAGE_TYPE}.hex F:/_Repository/Progetti/Prodotti/2016/FFPR1601_MercurySystem/20_Output/20_SwProjects/SW_BaseBoards/trunk/Bootloader/BootFwk/MercuryBoot_BB110.X/dist/default/production/MercuryBoot_BB110.X.production.hex -odist/${CND_CONF}/production/MercuryFwk_BB110.X.production.unified.hex
...
.build-subprojects:
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
	cd /D F:/_Repository/Progetti/Prodotti/2016/FFPR1601_MercurySystem/20_Output/20_SwProjects/SW_BaseBoards/trunk/Bootloader/BootFwk/MercuryBoot_BB110.X && ${MAKE}  -f Makefile CONF=default TYPE_IMAGE=DEBUG_RUN
else
	cd /D F:/_Repository/Progetti/Prodotti/2016/FFPR1601_MercurySystem/20_Output/20_SwProjects/SW_BaseBoards/trunk/Bootloader/BootFwk/MercuryBoot_BB110.X && ${MAKE}  -f Makefile CONF=default
endif


# Subprojects
.clean-subprojects:
	cd /D F:/_Repository/Progetti/Prodotti/2016/FFPR1601_MercurySystem/20_Output/20_SwProjects/SW_BaseBoards/trunk/Bootloader/BootFwk/MercuryBoot_BB110.X && rm -rf "build/default" "dist/default"
