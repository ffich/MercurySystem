...
************************************************************************/
/* Data direction register */
#define BSP_LCD_RS_TRIS                                  TRISAbits.TRISA5
#define BSP_LCD_EN_TRIS                                  TRISBbits.TRISB5
#define BSP_LCD_D4_TRIS                                  TRISAbits.TRISA2
#define BSP_LCD_D5_TRIS                                  TRISCbits.TRISC0
#define BSP_LCD_D6_TRIS                                  TRISCbits.TRISC1
#define BSP_LCD_D7_TRIS                                  TRISCbits.TRISC2
#define BSP_LCD_BL_TRIS                                  TRISCbits.TRISC7

/* LAT registers */
#define BSP_LCD_RS_LAT                                   LATAbits.LATA5
#define BSP_LCD_EN_LAT                                   LATBbits.LATB5
#define BSP_LCD_D4_LAT                                   LATAbits.LATA2
#define BSP_LCD_D5_LAT                                   LATCbits.LATC0
#define BSP_LCD_D6_LAT                                   LATCbits.LATC1
#define BSP_LCD_D7_LAT                                   LATCbits.LATC2
#define BSP_LCD_BL_LAT                                   LATCbits.LATC7
...
************************************************************************/
/* Data direction register */
#define BSP_CP_SHDN_TRIS                                 TRISAbits.TRISA4
/* Resource Alias */
#define BSP_CP_SHDN                                      LATAbits.LATA4
