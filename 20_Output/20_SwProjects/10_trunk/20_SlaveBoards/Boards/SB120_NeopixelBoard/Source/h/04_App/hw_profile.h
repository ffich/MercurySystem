...
************************************************************************/
/* Data direction register */
#define BSP_NEOPIXEL_PIN_1_TRIS                           TRISAbits.TRISA2
#define BSP_NEOPIXEL_PIN_2_TRIS                           TRISCbits.TRISC1
#define BSP_NEOPIXEL_PIN_3_TRIS                           TRISCbits.TRISC2

/* Resource Alias */
#define BSP_NEOPIXEL_1_PIN                                LATAbits.LATA2
#define BSP_NEOPIXEL_2_PIN                                LATCbits.LATC1
#define BSP_NEOPIXEL_3_PIN                                LATCbits.LATC2
