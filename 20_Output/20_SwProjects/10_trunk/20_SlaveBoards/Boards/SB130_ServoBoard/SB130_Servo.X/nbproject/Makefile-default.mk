...
Device=PIC16F1829
ProjectDir="F:\10_Repository\Progetti\Prodotti\2016\FFPR1601_MercurySystem\20_Output\20_SwProjects\SW_SlaveBoards\trunk\Boards\SB130_ServoBoard\SB130_Servo.X"
ConfName=default
ImagePath="dist\default\${IMAGE_TYPE}\SB130_Servo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\default\${IMAGE_TYPE}"
ImageName="SB130_Servo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	@echo "--------------------------------------"
	@echo "User defined post-build step: [xcopy /s/y "dist\default\production\SB130_Servo.X.production.hex" "..\..\01_FwImages\"]"
...
dist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=icd3  -DXPRJ_default=$(CND_CONF)  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"../../../Framework/MercuryFwk/Source/h/01_Hal/01_Sys" -I"../../../Framework/MercuryFwk/Source/h/01_Hal/02_Drv" -I"../../../Framework/MercuryFwk/Source/h/02_Osl" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/01_Pml/01_SlvI2c" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/01_Pml/02_SlvSer" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/02_Ssl" -I"../Source/h/04_App" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"../../../Framework/MercuryFwk/Source/h/01_Hal/01_Sys" -I"../../../Framework/MercuryFwk/Source/h/01_Hal/02_Drv" -I"../../../Framework/MercuryFwk/Source/h/02_Osl" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/01_Pml/01_SlvI2c" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/01_Pml/02_SlvSer" -I"../../../Framework/MercuryFwk/Source/h/03_Sml/02_Ssl" -I"../Source/h/04_App" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SB130_Servo.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
